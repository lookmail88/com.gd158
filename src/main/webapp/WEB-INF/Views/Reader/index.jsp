...
<script language="javascript"
	src="<%=request.getContextPath()%>/js/lib/jquery-1.6.2.js"
...
<body>
	...
	<div id="top">
		<div id="icon">
			<li><img src="<%=request.getContextPath()%>/imgs/icon.png"
				width="105" height="25" alt="Gd158" longdesc="http://www.gd158.net" />

				<span>账户类型：读者|</span> <span>切换账户类型</span>
		...
		<div id="nav">
			...
			<ul id="search"
				...
				<li class="list_type_style_none float_right margin_right_15"><img
					src="<%=request.getContextPath()%>/imgs/search_1.png" /></li>
				<li class="list_type_style_none float_right margin_right_15"><input
					name="" type="text" /></li>
				<li class="list_type_style_none float_right margin_right_15"><img
					src="<%=request.getContextPath()%>/imgs/Arrow_1.png" /></li>
	...
	<div id="FirstNews" class="box_out border_radius_0px ">
		...
		<ul class=" float_left  text_vertical_mid">
			<li class=" list_type_style_none  width_465 float_left"><img
				src="<%=request.getContextPath()%>/imgs/default_topnews.png"
				width="465" height="245" alt="今日头条" /></li>
			<li
		...
		<div
			...
			<ul class="news">
				...
				<li class="list_type_style_none  height_168 width_310"><a
					href="#" class="mask"><img
						src="<%=request.getContextPath()%>/imgs/news_1.png" width="310" /></a></li>
			...
			<ul>
				<li
					...
					<span class="float_right margin_right_15 margin_top_10"><img
						src="<%=request.getContextPath()%>/imgs/arrow2.gif" width="6"
						height="11" /></span>
				</li>
				<li
			...
			<ul class="">
				<li class="list_type_style_none height_25 border_bottom_1px_gary">
					<span class="float_left"><img
						src="<%=request.getContextPath()%>/imgs/icon_2.png" width="52"
						height="25" /></span> <span
				...
				<li
					...
					<span class="margin_top_10 float_left"><img
						src="<%=request.getContextPath()%>/imgs/zt_1.png" width="52"
						height="52" class=" border_1px" /></span> <span
					class="float_left margin_top_10 margin_left_10 width_200 ">
						<a href="#"
				...
				<li
					...
					<ul>
						...
						<li class="list_type_style_none  height_80   margin_left_10">
							<span class=" float_left"><img
								src="<%=request.getContextPath()%>/imgs/news_2.png" width="65"
								height="35" /></span> <span
					...
					<ul>
						<li
							...
							<span class="margin_left_15 margin_top_15 float_left"><img
								src="<%=request.getContextPath()%>/imgs/logo_depart_1.png"
								width="18" height="18" /></span> <span
						...
						<li
							...
							<span class="margin_left_15 margin_top_15 float_left"><img
								src="<%=request.getContextPath()%>/imgs/logo_depart_2.png"
								width="18" height="18" /></span> <span
						...
						<li
							class="list_type_style_none height_40 border_bottom_1px_gary border_top_1px_white ">
							<span class="margin_left_15 margin_top_15 float_left"><img
								src="<%=request.getContextPath()%>/imgs/logo_depart_3.png"
								width="18" height="18" /></span> <span
